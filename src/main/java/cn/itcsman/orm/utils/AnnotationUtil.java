package cn.itcsman.orm.utils;

import cn.itcsman.orm.annotation.Column;
import cn.itcsman.orm.annotation.ID;
import cn.itcsman.orm.annotation.Table;
    ...
    */
    public static String getTableName(Class clz) {
        ...
        if (clz.isAnnotationPresent(Table.class)) {
            Table ormTable = (Table) clz.getAnnotation(Table.class);
            return ormTable.name();
        } else {
            System.out.println("缺少 Table 注解");
            return null;
        }
    }
        ...
        for (Field field : fields) {
            if (field.isAnnotationPresent(ID.class)) {
                ...
                if (field.isAnnotationPresent(Column.class)) {
                    ...
                    System.out.println("缺少 Column 注解");
                }
            }
        }
        if (flag) {
            System.out.println("缺少 Id 注解");
        }
        return map;
    }
